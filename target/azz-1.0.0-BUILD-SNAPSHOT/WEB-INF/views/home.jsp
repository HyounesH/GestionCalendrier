				...
				<div class="col-sm-7">
					<div class="jumbotron">
						...
						<f:form cssClass="form" modelAttribute="utilisateur"
							...
							<br>
							<p>
								vous avez déjà un compte ? <span><a  href="" data-toggle="modal"
									data-target="#modalId" data-keyboard="true" class="badge badgre-primary">Login</a></span>
							</p>
							<p><b style="color: red;">${resultat}</b></p>
						</f:form>
					</div>
				</div>
			</div>
